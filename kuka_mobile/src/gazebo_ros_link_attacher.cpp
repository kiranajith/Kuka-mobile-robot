...
#include "kuka_mobile/Attach.h"
#include "kuka_mobile/AttachRequest.h"
#include "kuka_mobile/AttachResponse.h"
...
namespace gazebo
{
  ...
  bool GazeboRosLinkAttacher::attach_callback(kuka_mobile::Attach::Request &req,
                                              kuka_mobile::Attach::Response &res)
  {
  ...
  bool GazeboRosLinkAttacher::detach_callback(kuka_mobile::Attach::Request &req,
                                              kuka_mobile::Attach::Response &res){
